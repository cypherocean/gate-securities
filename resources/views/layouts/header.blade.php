        ...
        <div class="navbar-header" data-logobg="skin6">
            ...
            <div class="navbar-brand">
                <a href="{{ route('dashboard') }}">
                    <b class="logo-icon">
                        <img src="{{ _small_logo() }}" alt="homepage" class="dark-logo" style="max-width: 45px; max-height: 45px;" />
                        <img src="{{ _small_logo() }}" alt="homepage" class="light-logo" style="max-width: 45px; max-height: 45px;" />
                    </b>
